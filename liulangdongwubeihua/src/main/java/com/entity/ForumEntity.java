...
public class ForumEntity<T> implements Serializable {
     ...
     * 自愿者
     */
    @TableField(value = "ziyuanzhe_id")

    private Integer ziyuanzheId;
    ...
    public void setZiyuanzheId(Integer ziyuanzheId) {
        this.ziyuanzheId = ziyuanzheId;
    }
    /**
	 * 设置：管理员
	 */
